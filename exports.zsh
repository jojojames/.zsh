...
export PATH=$USER_BIN:$RVM_BIN:$CASK_ELISP_BIN:$LOCAL_BIN:$GRAILS_HOME/bin:$GRADLE_HOME:$ERLANG:$CABAL:$SBIN_BIN:$HEROKU:$ANDROID_TOOLS:$ANDROID_PLATFORM_TOOLS:$MONOTOUCH_BIN:$MONODROID_BIN:$POSTGRES:$OPT_BIN:$OPT_SBIN:$XAMP:$CASSANDRA:$REDIS:$PATH
